...
ALLOWED_HOSTS = ["localhost", "18.232.144.172"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "44.198.177.133",  # Dirección IP de la base de datos
